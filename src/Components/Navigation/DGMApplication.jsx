...
import DGMTable from '../Navigation/DGMTable'

const DGMApplication = () => {
  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              <div className="title-container">
                ...
                >
                  Distribute Applications to DGM
                </Typography>
                <Typography
                  variant="body2"
                    ...
                    >
                      ...
                      <div>
                        ...
                        <Field
                          ...
                          onChange={(e) => setFieldValue('zoneeName', e.target.value)}
                        >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <Field
                          ...
                          disabled
                          variant="outlined"
                          placeholder="Available App No From"
                          InputProps={{ style: { height: '40px', fontSize: '14px', color: '#101828' } }}
                          style={{ marginTop: '8px' }}
                        />
                      </div>
      ...
      <div style={{ width: '100%' }}>
        <DGMTable onUpdate={handleUpdateFromTable} />
      </div>
    </div>
  );
};
